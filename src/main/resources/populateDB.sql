...
CREATE TABLE Score (id LONG PRIMARY KEY AUTO_INCREMENT NOT NULL,
userID LONG,
balance DECIMAL(19,4),
currencyCode VARCHAR(30)
);

CREATE UNIQUE INDEX idx_acc on Score(userID);
...
INSERT INTO Score (userId,balance,currencyCode) VALUES (2,500.0000,'EUR');
INSERT INTO Score (userId,balance,currencyCode) VALUES (1,500.0000,'GBP');
INSERT INTO Score (userId,balance,currencyCode) VALUES (2,500.0000,'GBP');